...
public class ImagePagerAdapter extends RecyclingPagerAdapter {
    ...
    public ImagePagerAdapter(Context context, ArrayList<picData> datas, EventClick eventClick) {
    ...
    public View getView(int position, View convertView, ViewGroup container) {
        ...
        Glide.with(context).load(datas.get(getPosition(position)).getPicUrl())
